...
COPY ./config/nagios/contacts.cfg /etc/nagios4/objects/localhost.cfg
COPY ./config/nagios/extracommands.cfg /etc/nagios4/objects/localhost.cfg
COPY ./config/nagios/localhost.cfg /etc/nagios4/objects/localhost.cfg
COPY ./config/nagios/nagios.cfg /etc/nagios4/nagios.cfg
COPY ./config/nagios/printer.cfg /etc/nagios4/printer.cfg
COPY ./config/nagios/switch.cfg /etc/nagios4/switch.cfg
COPY ./config/nagios/templates.cfg /etc/nagios4/templates.cfg
COPY ./config/nagios/timeperiods.cfg /etc/nagios4/timeperiods.cfg
COPY ./config/nagios/windows.cfg /etc/nagios4/windows.cfg
